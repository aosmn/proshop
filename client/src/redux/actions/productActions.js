...
export const resetProductCreate = () => async (dispatch, getState) => {
  dispatch({
...
export const resetProductUpdate = () => async (dispatch, getState) => {
  dispatch({
...
export const resetCreateReview = () => async (dispatch, getState) => {
  dispatch({
